...
export const en: Translation = {
  ...
  agent: {
    ...
    byokPoints: [
      ...
      'Structural changes can be undone in one step; a scene-prose rewrite cannot, yet'
    ]
  },
...
export const ko: Translation = {
  ...
  agent: {
    ...
    byokPoints: [
      ...
      '구조 변경은 한 번에 되돌릴 수 있지만, 씬 본문 다시쓰기는 아직 되돌릴 수 없습니다'
    ]
  },
...
export const ja: Translation = {
  ...
  agent: {
    ...
    byokPoints: [
      ...
      '構造的な変更は一手で取り消せますが、シーン本文の書き直しはまだ取り消せません'
    ]
  },
